  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-gray-800">Entradas Financeiras</h2>
          <p className="text-gray-500">Registre suas vendas diárias ou aportes.</p>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        <h3 className="text-lg font-semibold mb-4 text-green-700 flex items-center gap-2">
          <PlusCircle size={20} /> Nova Entrada (Receita)
        </h3>
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Canal/Categoria</label>
            <select 
              className="w-full border border-gray-300 rounded-lg px-3 py-2 outline-none"
              value={form.category}
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
         <div className="p-4 bg-gray-50 border-b border-gray-100 flex items-center gap-2">
            ...
            <h3 className="font-bold text-gray-700">Histórico de Entradas</h3>
         </div>
